<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StudentLogin.aspx.cs" Inherits="Attendance_System.StudentLogin" %>
...
<body style="background-image:url(images/pic3.jpg);background-position:center;background-repeat:no-repeat;">
    <form id="form1" runat="server">
        <div style="height:450px;">
             <table style="width:565px;height:421px;background-color:aquamarine;margin:0 auto">
               <tr>
